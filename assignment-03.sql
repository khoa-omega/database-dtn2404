...
-- Tạo bảng type_Câu
DROP TABLE IF EXISTS type_Câu;
CREATE TABLE type_Câu (
	type_id INT PRIMARY KEY AUTO_INCREMENT,
	type_name ENUM("Essay", "Multiple-Choice") 
);

-- Tạo bảng category_Câu
DROP TABLE IF EXISTS category_Câu;
CREATE TABLE category_Câu (
	category_id INT PRIMARY KEY AUTO_INCREMENT,
	category_name VARCHAR(50) 
);

-- Tạo bảng Câu
DROP TABLE IF EXISTS Câu;
CREATE TABLE Câu (
	Câu_id INT PRIMARY KEY AUTO_INCREMENT,
	content VARCHAR(50),
	category_id INT,
	type_id INT,
	creator_id INT,
	...
	FOREIGN KEY (category_id)
		REFERENCES category_Câu (category_id)
        ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (type_id)
		REFERENCES type_Câu (type_id)
        ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (creator_id)
		REFERENCES account (account_id)
        ON UPDATE CASCADE ON DELETE CASCADE
...
-- Tạo bảng exam_Câu
DROP TABLE IF EXISTS exam_Câu;
CREATE TABLE exam_Câu (
	exam_id INT,
	Câu_id INT,
	PRIMARY KEY (exam_id, Câu_id),
	FOREIGN KEY (exam_id)
...
-- Thêm dữ liệu cho bảng type_Câu
INSERT INTO type_Câu (type_name) VALUES ("Essay"), ("Multiple-Choice"); 

-- Thêm dữ liệu cho bảng category_Câu
INSERT INTO category_Câu   (category_name)
VALUES                          ("Java"       ),
                                ("ASP.NET"    ),
                                ("ADO.NET"    ),
                                ("SQL"        ),
...
-- Thêm dữ liệu cho bảng Câu
INSERT INTO Câu    (content          , category_id, type_id, creator_id, created_date)
...
INSERT INTO answer  (content     , Câu_id, is_correct)
...
-- Thêm dữ liệu cho bảng exam_Câu
INSERT INTO exam_Câu   (Câu_id, exam_id)
VALUES                      (1         , 1      ),
                            (2         , 2      ),
                            (3         , 1      ),
                            (4         , 4      ),
